...
@Component({
  selector: 'app-calendar-widget-ios-medium-agenda',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './calendar-widget-ios-medium-agenda.component.html',
  styleUrl: './calendar-widget-ios-medium-agenda.component.scss'
})
export class CalendarWidgetIosMediumAgendaComponent {
  now = new Date();
  ...
  get upcomingItems(): Item[] {
    ...
    return this.itemsSvc.items()
      ...
      .slice(0, 4); // Medium widget can fit more
  }
